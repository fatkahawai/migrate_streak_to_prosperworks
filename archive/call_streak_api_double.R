...
#$$$
          ...
          if( nrow(taskFeed) >0 ){
#$$$ DEBUG
            print(paste("ADD_TASK events",as.character(nrow(taskFeed)),"rows"))
#$$$$
...
if(raw.result$status_code == 200){
  ...
  write.csv(allStages.df, file="~/Downloads/streak_stages.csv") 
...
if(raw.result$status_code == 200){
  ...
  write.csv(allFields.df, file="~/Downloads/streak_fields.csv") 
...
#              boxes$fields.1058)
    ...
    write.csv(boxes.df, file="~/Downloads/streak_boxes.csv") 
